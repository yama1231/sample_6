...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('reservation_slots.update', $reservationSlot) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" 
                                    ...
                                    value="{{ old('reservation_date', $reservationSlot->reservation_date->format('Y-m-d')) }}" 
                                    required>
                            ...
                            <select class="form-select @error('room_type_id') is-invalid @enderror" 
                                ...
                                @foreach ($roomTypes as $roomType)
                                    <option value="{{ $roomType->id }}" 
                                            {{ old('room_type_id', $reservationSlot->room_type_id) == $roomType->id ? 'selected' : '' }}>
